...
// TODO(arch): three 0.184.0 deprecates THREE.Clock, causing console warnings from @react-three/fiber internals.
// Consider downgrading three or waiting for a @react-three/fiber patch to use THREE.Timer instead.
