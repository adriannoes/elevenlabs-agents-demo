...
4.  **Save PRD:** Save the generated document as `prd-[feature-name].md` inside the `/product/prd` directory.
...
7.  **Technical Considerations (Optional):**
    ...
    *   **Consult**: `engineering/architecture/tech-stack-decisions.md` for approved stack choices (e.g., Next.js 15, Pydantic v2).
